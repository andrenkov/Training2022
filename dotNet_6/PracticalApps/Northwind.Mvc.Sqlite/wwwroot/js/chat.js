"use strict";
/*
 * creates a SignalR hub connection builder specifying the relative URL
 ...
 * When the connection gets a ReceiveMessage call from the server-side hub, it adds a list item element to the messages unordered list.
*/
